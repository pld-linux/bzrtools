...
%description -l pl
BZrTools to zeastaw wtyczek do programu Bazaar-NG (bzr). Zestaw zawiera nastêpuj±ce narzêdzia:
...
* shelve/unshelve - pozwala na powrót do wcze¶niejszych zmian, zatwierdzenia zmian i przywrócenia stanu sprzed dokonania zmian
